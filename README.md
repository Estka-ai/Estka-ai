...
|---------|-------------|-------|
| **[305 Express](https://github.com/Estka-ai)** | Logistics route management platform · 598 automated tests · production-ready | FastAPI · Vue · Expo |
| **[Olfatif](https://github.com/Estka-ai)** | Wholesale perfume platform — quotations, catalog, production tracking & analytics | Next.js · FastAPI · AI |
| **[Eden Bot](https://github.com/Estka-ai/eden-bot)** | AI customer service agent with RAG for a language academy | LangChain · ChromaDB · Node.js |
| **[VoiceAgent](https://github.com/Estka-ai/voiceagent)** | Real-time AI voice agent with GPT-4o, STT/TTS and web search | FastAPI · React · Fish Audio |
| **[Muninn](https://github.com/Estka-ai/muninn)** | Commercial evaluation platform with AI scoring and Go API gateway | Go · Python · React |
| **[MineCL](https://github.com/Estka-ai/MineCL)** | Functional Minecraft clone running in the browser — React + Vite | JavaScript · Vite |
